			...
			<section class="single-post">
				<div class="container">
					...
					<?php while ( have_posts() ) : the_post(); 
						...
						$image_url = dmz_get_meta( 'foto_min_club' );	?>
						...
						<figure class="preaching-image">
							...
							<figcaption>
								<div class="preaching-image__wrap d-flex align-i-end">
									...
									<?php endif; ?>
									<?php if( dmz_get_meta( 'word_club' ) ): ?>
										<a class="preaching-image__links preaching-image__links_video" href="<?php echo esc_url( dmz_get_meta( 'word_club' ) ); ?>" data-fancybox >
								...
								<p class="preaching-image__desc">
									<?php echo esc_html( dmz_get_meta( 'subtitle_club' ) ); ?>
								</p>
							</figcaption>
						</figure>
					</div>
